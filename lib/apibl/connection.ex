...
defmodule APIBL.Connection do
  @moduledoc """
  Handle Tesla connections for APIBL.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, APIBL.Connection,
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:beatleader, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - APIBL v1 - elixir"
        )
      )
