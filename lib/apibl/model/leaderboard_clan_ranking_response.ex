...
defmodule APIBL.Model.LeaderboardClanRankingResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :clanRanking => [APIBL.Model.ClanRankingResponse.t] | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:clanRanking, :list, APIBL.Model.ClanRankingResponse)
  end
end
