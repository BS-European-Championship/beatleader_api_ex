...
defmodule APIBL.Model.ScoreResponseWithMyScore do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :leaderboard => APIBL.Model.LeaderboardResponse.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:leaderboard, :struct, APIBL.Model.LeaderboardResponse)
